...
namespace MasterGradeSearch.Web.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,CityId,Name")] District district)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,CityId,Name")] District district)
        {
            if (ModelState.IsValid)
            {
